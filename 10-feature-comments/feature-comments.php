<?php
/*
Plugin Name: 10-Featured Comments
Plugin URI: http://pippinsplugins.com/featured-comments
Description: Added in Pippin's Featured Comments plugin as part of the exercise, in order to learn about simple plugin development.
Version: 1.2.6
